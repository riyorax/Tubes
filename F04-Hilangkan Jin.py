...
role = 'bandung_bondowoso' ### buat testcase, di main branch bakal dihapus
...
def hilangkan_jin():
    ...
    print(">>> hapusjin") ### Ini juga buat test case, bakal dihapus di main branch
...
# Buat testcase liat array data, bakal dihapus di main branch
